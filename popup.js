...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    providerDisplay.textContent = getProviderDisplayName(currentProvider);
    providerDisplay.className = `info-value provider-${currentProvider}`;
    modelDisplay.textContent = getModelDisplayName(effectiveModel, currentProvider);
